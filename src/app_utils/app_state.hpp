...
class AppState {
    ...
    style::elementStyle::manager::StyleNodesManager *styleManager;
    SDL_Window *window;
...
public:
    AppState(gui::element::manager::AbstractManager *manager, SDL_Window *window, SDL_Renderer *renderer,
             style::elementStyle::manager::StyleNodesManager *styleManager = nullptr, TTF_TextEngine *textEngine = nullptr);
    ~AppState();
    gui::element::manager::AbstractManager *getManager() const { return manager; }
    style::elementStyle::manager::StyleNodesManager *getStyleManager() const { return styleManager; }
