    ...
    namespace elementStyle {
        namespace manager {
            ...
            class ElementsStyleManager {
                ...
                void applySpecificStyleToElement(std::list<style::StyleBlock *> specificStyle, gui::elementStyle::ElementStyle *elementStyle, bool recursive = false);
            ...
            public:
                ...
                bool areElementSelectorsCompatibles(gui::elementStyle::ElementStyle *elementStyle, const style::StyleComponentDataList *componentsList);
